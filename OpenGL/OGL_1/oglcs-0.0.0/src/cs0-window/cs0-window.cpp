...
int main( void )
{
	...
	// Set Multisampling to 4, i.e., MSAA = 4
	glfwWindowHint(GLFW_SAMPLES, 4);

	// For this window test, we do not need any higher OpenGL version, So let us keep it OpenGL 3.2.
	...
	window = glfwCreateWindow( 800, 600, "OpenGL Code Snippet 1: Creating a Window", NULL, NULL);
	if( window == NULL ){
